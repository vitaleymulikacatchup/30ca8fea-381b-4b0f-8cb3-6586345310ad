...
import portfolioImages from './portfolioImages'; // Assume this imports the relevant array
  ...
  return (
    <SiteThemeProvider theme={{ styleVariant: 'futuristicAndOutOfBox', colorTemplate: 1, textAnimation: 'none' }}>
      <div className="bg-[linear-gradient(135deg,_#0b0f14,_#0d1220)]">
        ...
        <div id="portfolio">
          <BentoMediaGallery items={portfolioImages} className="mt-12" gridClassName="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8" />
        </div>
        <div id="about">
        ...
        <div id="testimonials">
          <CentralFAQ items={testimonialsData} />
        </div>
        <div id="contact">
